...
#precache( "fx", DOUBLETAP2_MACHINE_LIGHT_FX_FILE );
#precache( "material", DOUBLETAP2_SHADER );
...
{
	if ( level.CurrentMap == "zm_cosmodrome" || level.CurrentMap == "zm_prototype" )
		return;
...
function doubletap2_precache()
{
	...
	level._effect[DOUBLETAP2_MACHINE_LIGHT_FX] = DOUBLETAP2_MACHINE_LIGHT_FX_FILE;

	wardog_perk_hud::register_perk_shader(PERK_DOUBLETAP2, DOUBLETAP2_SHADER);
