...
#precache( "fx", SLEIGHT_OF_HAND_MACHINE_LIGHT_FX_FILE );
...
function sleight_of_hand_precache()
{
	...
	level._effect[SLEIGHT_OF_HAND_MACHINE_LIGHT_FX]			= SLEIGHT_OF_HAND_MACHINE_LIGHT_FX_FILE;

	wardog_perk_hud::register_perk_shader(PERK_SLEIGHT_OF_HAND, SLEIGHT_OF_HAND_SHADER);
