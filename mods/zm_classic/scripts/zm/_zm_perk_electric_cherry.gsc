...
#precache( "string", "ZOMBIE_PERK_ELECTRICCHERRY" );
...
function electric_cherry_precache()
{
	...
	level._effect[ELECTRIC_CHERRY_MACHINE_LIGHT_FX] = ELECTRIC_CHERRY_MACHINE_LIGHT_FX_FILE;

	wardog_perk_hud::register_perk_shader(PERK_ELECTRIC_CHERRY, ELECTRIC_CHERRY_SHADER);
